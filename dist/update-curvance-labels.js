...
import { discoverCurvanceMarkets, buildCurvanceLabels, } from "./fetch/curvance/labels.js";
...
async function main() {
    ...
    if (markets.length === 0) {
        ...
        console.error("Curvance: discovery returned no markets — refusing to write labels.");
        process.exit(1);
    }
    ...
    console.log(`Curvance labels: ${Object.keys(built.names).length - 1} market label(s) + base (${res})`);
