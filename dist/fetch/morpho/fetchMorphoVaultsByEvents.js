...
const CREATE_VAULT_V2 = parseAbiItem("event CreateVaultV2(address indexed owner, address indexed asset, bytes32 salt, address indexed vaultV2)");
/**
 ...
 * or unreachable — callers should catch per-chain and continue.
 */
export async function fetchMorphoVaultV2ByEvents(chainId, factory) {
    const assetOf = new Map(); // vault -> underlying
