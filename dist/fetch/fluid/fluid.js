...
function symbolFor(underlying, tokens) {
    if (underlying === NATIVE_SENTINEL)
        return "ETH";
    ...
    async fetchData() {
        ...
        for (let i = 0; i < chainEntries.length; i++) {
            ...
            try {
                ...
                const vaultMetas = await getVaultMetas(chainId, vaultAddrs, fTokensByUnderlying, resolvers);
