// Minimal MarketCompressor ABI — just getMarkets, which returns full
// MarketData[]. We only read creditManagers[*].creditManager.{baseParams.addr,
// name} and creditManagers[*].creditFacade.{expirationDate, isPaused}, but
// the whole struct must be declared for viem to decode correctly.
